...
public class StringOptUtils {
     ...
     * @return
     */
    public static String toHumpUpper(String s) {
     ...
     * @return
     */
    public static String toHumpUpper(String s, String c) {
     ...
     * @return
     */
    public static String toHumpLower(String s) {
        String res = toHumpUpper(s) ;
     ...
     * @return
     */
    public static String toHumpLower(String s, String c) {
        String res = toHumpUpper(s, c) ;
        return res.toLowerCase().charAt(0) + res.substring(1) ;
    }
